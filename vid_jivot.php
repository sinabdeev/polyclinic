...
require_once("mdl_sql.php");
	...
	echo "<tr class='wapka'><td class='wapka' align=center><B>Номер вида животного</B></td>";
	echo "<td class='wapka' align=center><a class='shapka' href='vid_jivot.php?order=".(Invers($order))."'><B>Вид животного</B></a>";
	order($order);
	echo "</td>";
